    ...
    <div style={{maxWidth:"550px", margin:"0px auto", marginTop:"50px"}}>
      <div style={{margin:"18px 0px",borderBottom:"1px solid grey"}}>
        ...
        <li className="nav-item">
            <button onClick={showPostTab} style={{backgroundColor:'black'}}>
              <GridOnIcon style={{color:'white'}}></GridOnIcon>
            <i style={{color:'white'}}>&nbsp;POST</i>
            </button>
           
        </li>
        <li className="nav-item" >
            <button onClick={showSaveTab} style={{backgroundColor:'black'}}>
              <BookmarkBorderIcon style={{color:'white'}}></BookmarkBorderIcon>
              
              <i style={{color:'white'}}>&nbsp;SAVED</i>
              
              </button>
        </li>
        <li className="nav-item">
            <button onClick={showTagTab} style={{backgroundColor:'black'}}>
              <AssignmentIndIcon style={{color:'white'}}></AssignmentIndIcon>
              <i style={{color:'white'}}>&nbsp;TAG</i></button>
        </li>
      </ul>
      </div>
