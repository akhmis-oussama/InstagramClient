    ...
    <div className='story'>
      <div className='story-box'>
                ...
                <React.Fragment key={index}>
                  <div className='story_1'>
                    ...
                    >
                        ...
                        <p className='story_H' style={{color:'white'}}>{story.name}</p>
                    </button>
                </div>
        ...
        <button className='storybtn' onClick={()=>setAddStoryModal(true)}>
            <i className='fa fa-plus-circle story_image' style={{color:'white'}}></i>
            <i className='story_S' style={{display:"flex", color:'white'}}>Add Story</i>    
        </button>
        </div>
      </div>
      <i className='  fas fa-chevron-circle-left icon-style2 nav-left' 
    style={{ fontSize: '24px' }}></i>
    <i className=' fas fa-chevron-circle-right icon-style1  nav-right' style={{ fontSize: '24px', color:'white' }}></i>
